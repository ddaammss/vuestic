<template>
  <div>
    ...
    <div class="table-container">
      <div class="table-header">환불 정책 관리</div>
...
const fetDetail = async () => {
  ...
  try {
    ...
    const response = await axios.post('/settings/refund/detail', {
      type: 'refund'
    })
...
const save = async () => {
  try {
    ...
    const response = await axios.post('/settings/refund/upsert', saveData)
